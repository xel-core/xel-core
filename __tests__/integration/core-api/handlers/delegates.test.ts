...
beforeAll(async () => {
    ...
    wallet.setExtraAttribute("delegate", Object.assign(delegate, {
...
describe("API 2.0 - Delegates", () => {
    describe("GET /delegates", () => {
        ...
        it("should GET all the delegates sorted by votes,desc", async () => {
            ...
            wallet.setExtraAttribute("delegate.voteBalance", Utils.BigNumber.make(12500000000000000));
            wm.reindex(wallet);
            ...
            expect(response.data.data[0].username).toBe(wallet.getExtraAttribute("delegate.username"));
            expect(response.data.data[0].votes).toBe(+wallet.getExtraAttribute<Utils.BigNumber>("voteBalance").toFixed());
        });
