...
describe("Models - Wallet", () => {
    ...
    describe("apply block", () => {
        ...
        beforeEach(() => {
            ...
            testWallet.setExtraAttribute("delegate", delegate);
        ...
        it("should apply correct block", () => {
            ...
            const delegate: State.IWalletDelegateAttributes = testWallet.getExtraAttribute("delegate");
        ...
        it("should not apply incorrect block", () => {
            ...
            const delegate: State.IWalletDelegateAttributes = testWallet.getExtraAttribute("delegate");
            const original: State.IWalletDelegateAttributes = originalWallet.getExtraAttribute("delegate");
    ...
    describe("revert block", () => {
        ...
        walletInit.setExtraAttribute("delegate", {
        ...
        it("should revert block if generator public key matches the wallet public key", () => {
            ...
            const initDelegate: State.IWalletDelegateAttributes = walletInit.getExtraAttribute("delegate");
            const testDelegate: State.IWalletDelegateAttributes = testWallet.getExtraAttribute("delegate");
    ...
    describe("audit transaction - auditApply", () => {
        ...
        it("should return correct audit data for delegate resignation type", () => {
            ...
            expect(audit).toEqual([
                ...
                { "Signature validation": true },
                { "Resigned delegate": testWallet.getExtraAttribute("delegate.username") },
            ]);
        });
        ...
        describe("when wallet has multisignature", () => {
            it("should return correct audit data for Transfer type", () => {
                ...
                testWallet.setExtraAttribute("multiSignature", {
                    min: 3,
                    publicKeys: [
        ...
        describe("when wallet has 2nd public key", () => {
            it("should return correct audit data for Transfer type", () => {
                ...
                testWallet.setExtraAttribute("secondPublicKey", "02db1d199f20038e569500895b3521a453b2924e4a07c75aa9f7bf2aa4ad71392d");
